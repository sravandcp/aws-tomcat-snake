...
<html>
  ...
  <body>
    ...
    <div id="hate" class="container snakes snake-hater">
      <h1 class="cover-heading">Does it have videos?</h1>
      <p class="lead">A safety resource from AWS Cloud by Sravan Kumar.</p>
      <iframe width="727" height="409" src="https://www.youtube.com/embed/_PtSWvimIJ8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <p class="lead">wATCH VIDEO IN Cloud.</p>
      <iframe width="727" height="409" src="https://www.youtube.com/embed/4RUdLfNlYn0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
